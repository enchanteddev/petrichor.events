...
export const closedRegistrations = ['TF07'];
...
export let cultural = {
	events: [
...

		{
			name: "Click n' Roll",
			about:
				'A Showcase of Frames. This event will be conducted online. Participants have to capture the essence of the fest through photography and videography and create reels using them.',
			rulebook: {
				structure: [
		...
		},
		{
			...
			about:
				"This no-fire Cooking Competition is designed to showcase participants' culinary creativity and skills in preparing delicious dishes without the use of open flames, such as gas stoves or induction cookers.",
			rulebook: {
				structure: [],
				judging: [
		...
		},
		{
			name: 'Voicestra',
			about:
				"Join our solo singing competition, welcoming voices from East and West, spanning every genre! Elevate your voice, captivate the audience, and let the world be spellbound by your talent. It's your moment to enchant and leave everyone breathless, no matter the genre or cultural influence every style is welcome",
			rulebook: {
				structure: [
		...
		},
		{
			name: 'Dynamic Duet',
			about:
				"Join us for the Duet Competition, where you and your teammate can weave musical magic together. Bring any genre to life, from classic to contemporary. It's not just a competition, it's a chance to create something beautiful and unforgettable as a team. ",
			rulebook: {
				structure: [
		...
		},
		{
			...
			about:
				'The event is all about unleashing your creativity and showcasing your face painting skills.',
			rulebook: {
				structure: [
					'',
		...
		},
		{
			name: 'Waste to Wow',
			about:
				' It is a craft out of waste competition where teams of two have to make beautiful crafts out of waste materials.\n\n',
			rulebook: {
				structure: [],
				judging: [
		...
		},
		{
			name: 'Pixel Palette',
			theme:
				'Depict the ever-shifting landscapes of emotions through vibrant and dynamic digital art, capturing the essence of emotional metamorphosis.',
			about:
				"It's an online competition and participants are needed to submit their digital artworks according to the provided theme.",
			rulebook: {
				structure: [
		...
		},
		{
			name: 'DROP THE BEAT',
			about:
				'A 1 vs 1 battle where each pair of dancers will be challenged to\ndance to the unpredictable, varied beats.',
			rulebook: {
				structure: [],
				judging: [
		...
		},
		{
			name: 'KATHA',
			theme:
				'Write about a character who discovers a mysterious portal that leads to infinite parallel universes, each with its own set of transformations and challenges.',
			about:
				'Where words become world. An individual event where participants will write a short story of 1000-2000 words in English or Hindi based on the given prompts.',
			rulebook: {
				structure: ['This event will be conducted online.'],
				judging: ['1.Creativity - 35%', '2.Originality - 35%', '3.Relevance to prompt - 30%'],
		...
		},
		{
			name: 'KAVYA',
			theme:
				'Create a poem that reflects on the cyclical nature of life, weaving themes of birth, growth, decay, and rebirth into a tapestry of infinite existence.',
			about:
				'Weaving verses, crafting dreams. An individual event where participants will write a poetry of 100-200 words in English or Hindi based on the given prompts.',
			rulebook: {
				structure: ['This event will be conducted online.'],
				judging: ['1.Creativity - 35%', '2.Originality - 35%', '3.Relevance to prompt - 30%'],
				prizes: ['₹2000', '₹1000', '₹500'],
		...
		},
		{
			...
			about:
				'Get ready for a mind blowing quiz on anything and everything under the sun and beyond.',
			rulebook: {
				structure: [
					'Registration fee for this event is ₹49 for each registrant.',
		...
		},
		{
			...
			about:
				'Get ready for the Sport and Entertainment Quiz cuz we\u2019ve got some \u2018slam dunk\u2019 questions for you. Brush up your knowledge on sports, pop culture and everything in between.',
			rulebook: {
				structure: [
					'Registration fee for this event is ₹49 for each registrant.',
					'1.The quiz consists of two rounds: prelims and finals.',
		...
		},
		{
			name: 'Valorant',
			about:
				'Welcome to the Valorant Clash Championship, where skilled players and passionate fans come together for an epic day of intense competition and camaraderie. This event is designed for Valorant enthusiasts of all levels, from casual gamers to aspiring professionals.',
			rulebook: {
				structure: [
					'Registration fee for this event is ₹49 for each registrant.',
	...
	events: [
		{
			name: 'Tessaract 2.0',
			about:
				'Participants are tasked with solving a sequence of challenges and riddles. The challenges will navigate them across various platforms and demand sharp, out-of-the-box thinking to successfully complete',
			rulebook: {
				structure: [
...

		{
			name: 'Game Forge',
			about:
				'An online game development competition where participants showcase their creative skills in\ndeveloping games using a Godot Engine.',
			rulebook: {
				structure: [
				...
				prizes: ['1. Rs. 4000', '2. Rs. 2500', '3. Rs. 1500'],
				rules: [
		...
		},
		{
			name: 'AlgoTrek',
			about:
				'Petrichor presents AlgoTrek, where your coding skills are your weapons. Use them wisely to fight hordes of challenging problems within 2.5 hours in this online CP contest.',
			rulebook: {
				structure: [
				...
				judging: ['Will be evaluated as per the platform its conducted on'],
				prizes: [
					'1. Rs. 5500',
					'2. Rs. 4500',
					'3. Rs. 3500',
		...
		},
		{
			...
			about:
				'An online simulation challenge where participants are expected to produce a trajectory plan to get the payload to its desired location, given a set of constraints such as as the fuel, the mass of the payload, etc.',
			rulebook: {
				structure: [
				...
				prizes: ['1. Rs. 3500', '2. Rs. 2000', '3. Rs. 1500'],
				rules: [
		...
		},
		{
			...
			rulebook: {
				...
				prizes: ['Total Pool = Rs. 15000', '1. Rs. 7000', '2. Rs. 5000', '3. Rs. 3000'],
				rules: [
		...
		},
		{
			name: 'Chipcraft',
			about:
				'This technical challenge invites you to create a customized PCB, integrating a microcontroller tailored to a given application.',
			rulebook: {
				structure: [
				...
				prizes: ['Total: ₹8,000', '1. Rs. 4,000', '2. Rs. 2,500', '3. Rs. 1,500'],
				rules: [
		...
		},
		{
			...
			about:
				'In the realm of knowledge, there are no boundaries, and the fun knows no limits. Petrichor\u2019 24 brings you Quizzanaire, a quiz competition exclusively for school students. It will be an inter school quiz competition.\n\nTopic: Anything and everything under the sun and beyond.\nParticipation: Teams of two or one\nRegistration fees: None',
			rulebook: {
				structure: [
				...
				prizes: ['Total Rs. 6000', '1. Rs. 3000', '2. Rs. 2000', '3. Rs. 1000'],
				rules: [
					'',
		...
		},
		{
			name: 'Drone Dash',
			about:
				'Welcome to Drone Dash, an exhilarating drone racing competition that challenges teams to navigate through hoops with precision and speed. Get ready to showcase your piloting skills in this thrilling event!',
			rulebook: {
				structure: [
				...
				prizes: ['1. Rs. 14450', '2. Rs. 9700', '3. Rs. 5850'],
				rules: [
		...
		},
		{
			...
			about:
				'A creativity and engineering prowess challenge where every team, with a limited selection of materials acquired through an auction, will have to craft a compact egg-protective structure.',
			rulebook: {
				structure: [
				...
				prizes: ['1. Rs. 4000', '2. Rs. 2400', '3. Rs. 1600'],
				rules: [
		...
		},
		{
			...
			rulebook: {
				...
				prizes: ['1. Rs. 5100', '2. Rs. 3500', '3. Rs. 2100'],
				rules: [
					'Basic Details',
...

		{
			name: 'Labyrinth 2.0',
			about:
				'Teams have to build an autonomous robot that can follow white lines and keep track of directions while going through the maze. The robot has to go through the path, reach the end point in the dry run, and then go from the starting point to the ending point in the shortest path in the actual run.',
			rulebook: {
				structure: [
					'Bot description',
				...
				prizes: ['1. Rs. 7500', '2. Rs. 4500', '3. Rs. 3000'],
				rules: [
					'Game Rules',
...

		{
			...
			about:
				'An offline event where participants are required to simulate a drone\u2019s stabilization and\nimplement the same on a provided hardware setup.',
			rulebook: {
				structure: [
					'1. Round 1 :',
...

		{
			...
			rulebook: {
				...
				judging: ['nil/later'],
				prizes: ['1. Rs. 16500', '2. Rs. 11500', '3. Rs. 7000'],
				rules: [
		...
		},
		{
			...
			about:
				'A five-day online trading competition designed to test your trading skills and knowledge in a simulated trading environment.',
			rulebook: {
				structure: [
				...
				prizes: ['1. Rs. 5000', '2. Rs. 3000', '3. Rs. 2000'],
				rules: [
	...
	workshops: [
		{
			name: 'AI Workshop',
			about:
				'Machine Learning is an essential skill for any aspiring data analyst and data scientist, and also for those who wish to transform a massive amount of raw data into trends and predictions. Machine learning is actively being used today, perhaps in many more places than one would expect. Join this workshop and discuss on some recent problem statements using ML',
			...
			id: 'WP00',
			regLink: 'https://bharatversity.com/events/eventdetails/ad71bb04-fea8-4fe8-bee5-b44c1ec82107'
		},
		{
			name: 'Robotics',
			about:
				'Embark on a comprehensive journey into wheeled robot dynamics, mastering the intricacies of differential drive kinematics, control strategies, and Python programming for simulation and trajectory tracking.',
			prereq: ['Basic Programming Skills'],
			fees: 1299,
			date: '27 & 28 Jan',
			regdate: '26 Jan',
			...
			id: 'WP01',
			regLink: 'https://bharatversity.com/events/eventdetails/44086a32-5a67-4d0c-aa5a-97de2f0172d8'
		},
		{
			name: 'Product Design',
			about:
				"Unlock the art and science of effective product management in our immersive workshop, where you'll refine your skills in ideation, prioritization, and execution to drive successful product outcomes.",
			prereq: [],
			fees: 1199,
			date: '27 & 28 Jan',
			regdate: '26 Jan',
			...
			id: 'WP02',
			regLink: 'https://bharatversity.com/events/eventdetails/f4dea3c7-16cd-4f99-bc44-78bd1d7908c0'
		},
		{
			name: 'Reinforcement Learning',
			about:
				'Unlock the power of machine learning through practical applications and hands-on exploration in our comprehensive Reinforcement Learning Workshop.',
			...
			id: 'WP03',
			regLink: 'https://bharatversity.com/events/eventdetails/871ba9a6-288a-46f2-9a12-01a86f3d2ecb'
		},
		{
			name: 'Startup and Entrepreneurship',
			about:
				'Empowering aspiring innovators and visionaries to navigate the entrepreneurial landscape through our immersive Startup and Entrepreneurship workshop.',
			prereq: [],
			fees: 1199,
			date: '27 & 28 Jan',
			regdate: '26 Jan',
			...
			id: 'WP04',
			regLink: 'https://bharatversity.com/events/eventdetails/13274a6b-f17d-42c2-8c2c-51770d063d40'
		},
		{
			name: 'Measurement Principles and Uncertainty Analysis',
			about:
				'Join us for an immersive workshop exploring Measurement Principles and Uncertainty Analysis, where precision meets insight in every measurement.',
			prereq: [],
			fees: 1199,
			date: '27 & 28 Jan',
			regdate: '26 Jan',
			...
			id: 'WP05',
			regLink: 'https://bharatversity.com/events/eventdetails/3d2d1369-20f6-4471-851d-3f9de38b0437'
		},
		{
			name: 'Competitive Programming',
			about:
				'Join us for a high-energy Competitive Programming workshop, where you will hone your algorithmic skills and tackle real-world coding challenges head-on!',
			prereq: ['Basic Programming'],
			fees: 1299,
			date: '27 & 28 Jan',
			regdate: '26 Jan',
			...
			speakers: ['YACC'],
			id: 'WP06',
			regLink: 'https://bharatversity.com/events/eventdetails/5834880d-4878-4c5f-8feb-11e9c6b82e50'
		}
	]
};
...
export const informals = [
	{
		...
		about:
			"Ready to make your move? Join King's Knightmare, the online chess showdown by Petrichor'24 in collaboration with chess.com. Registration is free, and exciting prizes await the strategic minds who conquer the board. Don't miss out—register now and let the chess battle begin!",
		location: 'Chess.com',
		date: ' 21-01-2024 and 22-01-2024',
		image: Chess,
		registerLink:
			'https://docs.google.com/forms/d/e/1FAIpQLSdzJLUonZ4UTuellHrrp2kATS-zTh8ZxJ6f0C3QcujdmFh4Cg/viewform?usp=sf_link'
	},
	{
		name: 'Laser Tag',
		about:
			'Dive into the ultimate laser showdown! Gather your squad, suit up in neon, and embark on an adrenaline-fueled mission under the glow of lasers. Are you ready for the ultimate tag challenge?',
		location: 'Nila Campus',
	...
	},
	{
		name: 'VR Gaming',
		about:
			"Step into the future of gaming at our VR Event! Immerse yourself in mind-bending worlds, conquer virtual challenges, and redefine your gaming experience. It's not just a game; it's a virtual adventure!",
		location: 'Nila Campus',
		date: ' 27-01-2024 and 28-01-2024',
		image: VR,
		registerLink: null
